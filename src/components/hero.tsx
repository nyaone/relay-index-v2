...
const DecorationBoard = ({
  ...
  >
    <div
      className={`relative aspect-1155/678 w-144.5 -translate-x-1/2 bg-linear-to-tr from-[#0ea5e9] to-[#f43f5e] opacity-30 sm:w-288.75 ${innerStyle}`}
      style={{
        clipPath:
...
const Hero = () => (
  <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen flex items-center">
    <DecorationBoard
      ...
      innerStyle="left-[calc(50%-11rem)] rotate-30 sm:left-[calc(50%-30rem)]"
    />
    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <a
            href="#join"
            className="rounded-md bg-primary px-3.5 py-2.5 font-semibold text-white shadow-xs hover:bg-sky-500 focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary transition-colors duration-300"
          >
            加入我们
          </a>
          <a
